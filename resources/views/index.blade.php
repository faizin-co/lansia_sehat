...
<body>
    ...
    <div class="st-top-header">
      <div class="container">
        <div class="st-top-header-in">
          ...
          <a href="#appointment" class="st-top-header-btn st-smooth-move">Login</a>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            <a class="st-site-branding" href="{{ route('index') }}"><img src="{{url('frontend/assets/img/logo.png')}}" alt="Lansia Sehat"></a>
          </div>
          <div class="st-main-header-right">
            <div class="st-nav">
              <ul class="st-nav-list st-onepage-nav">
                <li><a href="#home" class="st-smooth-move">Home</a></li>
                <li><a href="#about" class="st-smooth-move">Tentang Kami</a></li>
                <li><a href="#department" class="st-smooth-move">Layanan Kami</a></li>
                <li><a href="#gallery" class="st-smooth-move">Gallery</a></li>
                <li class="menu-item-has-children"><a href="#blog" class="st-smooth-move">Berita</a>
                </li>
  ...
  <div class="st-content">
        ...
        <div class="container">
          <div class="st-hero-text">
            ...
            <h1 class="st-hero-title cd-headline slide">
              Selamat datang <br>
              Di lansia sehat<br>
              Dapatkan informasi <br>
              Seputar
              <span class="cd-words-wrapper">
                <b class="is-visible">Jadwal.</b>
                <b>Hasil Screening.</b>
                <b>Berita. </b>
              </span>
            </h1>
            <div class="st-hero-subtitle">"Lansia Sehat" adalah platform kesehatan  <br>
                yang didedikasikan untuk mendukung kesejahteraan lansia.</div>
            <div class="st-hero-btn">
              <a href="#appointment" class="st-btn st-style1 st-color1 st-smooth-move">Hubungi Kami</a>
            </div>
          </div>
        </div>
    ...
    <section class="st-about-wrap" id="about">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Tentang Lansia Sehat</h2>
    ...
    <section id="department">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Layanan Kami</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="{{url('frontend/assets/img/icons/4.png')}}" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
          </div>
          <div class="st-section-heading-subtitle"> Kami menawarkan berbagai layanan yang dirancang khusus untuk lansia.</div>
        </div>
        <div class="st-height-b40 st-height-lg-b40"></div>
      </div>
      <div class="container">
          ...
          <ul class="st-tab-links st-style1 st-mp0">
            ...
            <li class="st-tab-title">
              <a href="#Cardiology" class="st-dip-blue-box">
                ...
                <span>Profil Posyandu Lansia</span>
              </a>
            </li>
            <li class="st-tab-title">
              <a href="#DentalCare" class="st-orange-box">
                ...
                <span>Program Edukasi Kesehatan</span>
              </a>
            </li>
            <li class="st-tab-title">
    ...
    <section id="gallery">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Gallery</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="{{url('frontend/assets/img/icons/4.png')}}" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
          </div>
          <div class="st-section-heading-subtitle">Berbagai Kegiatan Kami dkumentasikan disini. <br>
            </div>
        </div>
        <div class="st-height-b40 st-height-lg-b40"></div>
      </div>
        ...
        <div class="st-portfolio-wrapper">
          <div class="st-isotop-filter st-style1 text-center">
            <ul class="st-mp0">
              ...
              <li><a href="#" data-filter=".cardiology">Sosial</a></li>
              <li><a href="#" data-filter=".neurology">Skrining</a></li>
              <li><a href="#" data-filter=".urology">Edukasi</a></li>
              <li><a href="#" data-filter=".pulmonary">Rekreasi</a></li>
              <li><a href="#" data-filter=".traumatology">Konsultasi</a></li>
            </ul>
          </div>
    ...
    <section id="blog">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Berita Terkini</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="{{url('frontend/assets/img/icons/4.png')}}" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
          </div>
          <div class="st-section-heading-subtitle">Halaman berita menyediaan informasi seputar kesehatan.</div>
        </div>
        <div class="st-height-b40 st-height-lg-b40"></div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="st-post st-style3">
              ...
              <div class="st-post-info">
                <h2 class="st-post-title"><a href="blog-details-right-sidebar.html">Makanan Sehat untuk Lansia</a></h2>
                <div class="st-post-meta">
                  <span class="st-post-date">Nov 06, 2024</span>
                  <span>
                    Posted by:<a href="#" class="st-post-avatar">
                      <span class="st-post-avatar-text"> Faizin</span>
                    </a>
                  </span>
                </div>
                <div class="st-post-text">Panduan gizi seimbang untuk menjaga kebugaran.</div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="st-post st-style3">
              ...
              <div class="st-post-info">
                <h2 class="st-post-title"><a href="blog-details-right-sidebar.html">Olahraga Ringan yang Aman untuk Lansia</a></h2>
                <div class="st-post-meta">
                  <span class="st-post-date">Aug 22, 2024</span>
                  <span>
                    Posted by: <a href="#" class="st-post-avatar">
                      <span class="st-post-avatar-text"> Mieka</span>
                    </a>
                  </span>
                </div>
                <div class="st-post-text">Rekomendasi aktivitas fisik ringan.</div>
              </div>
              <div class="st-post-footer">
                <a href="blog-details-right-sidebar.html" class="st-btn st-style2 st-color1 st-size-medium">Read More</a>
              </div>
          ...
          <div class="col-lg-4">
            <div class="st-post st-style3">
              ...
              <div class="st-post-info">
                <h2 class="st-post-title"><a href="blog-details-right-sidebar.html">Pencegahan Penyakit Umum</a></h2>
                <div class="st-post-meta">
                  <span class="st-post-date">Aug 23, 2024</span>
                  <span>
                    Posted by:<a href="#" class="st-post-avatar">
                      <span class="st-post-avatar-text"> Devin</span>
                    </a>
                  </span>
                </div>
                <div class="st-post-text">Tips mencegah penyakit yang sering terjadi pada usia lanjut.</div>
              </div>
              <div class="st-post-footer">
                <a href="blog-details-right-sidebar.html" class="st-btn st-style2 st-color1 st-size-medium">Read More</a>
              </div>
    ...
    <section class="st-shape-wrap" id="contact">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Tetap Terhubung dengan Kami</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="{{url('frontend/assets/img/icons/4.png')}}" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
          </div>
          <div class="st-section-heading-subtitle">Bersama kami,
             <br>Terus perbarui informasi dan tips kesehatan untuk lansia yang Anda cintai.</div>
        </div>
        <div class="st-height-b40 st-height-lg-b40"></div>
      </div>
      <div class="container">
          ...
          <div class="col-lg-3">
            <div class="st-footer-widget">
              <div class="st-text-field">
                ...
                <div class="st-height-b25 st-height-lg-b25"></div>
                <div class="st-footer-text">Lansia Sehat hadir dengan misi memberikan pelayanan dan informasi kesehatan terbaik untuk para lansia.</div>
                <div class="st-height-b25 st-height-lg-b25"></div>
                <ul class="st-social-btn st-style1 st-mp0">
                  <li><a href="#"><i class="fab fa-facebook-square"></i></a></li>
                  <li><a href="#"><i class="fab fa-linkedin"></i></a></li>
          ...
          <div class="col-lg-3">
            <div class="st-footer-widget">
              ...
              <ul class="st-footer-widget-nav st-mp0">
                ...
                <li><a href="#"><i class="fas fa-chevron-right"></i>Layanan Kami</a></li>
      ...
      <div class="container">
        <div class="st-copyright-in">
          <div class="st-left-copyright">
            <div class="st-copyright-text">Copyright 2024. Group A Capstone Project</div>
          </div>
