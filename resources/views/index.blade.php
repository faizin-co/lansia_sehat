...
<head>
  ...
  <link rel="stylesheet" href="{{url('frontend/assets/css/jQueryUi.min.css')}}" />
  <link rel="stylesheet" href="{{url('frontend/assets/css/textRotate.css')}}" />
...
<body>
      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            <a class="st-site-branding" href="{{ route('index') }}"><img src="{{url('frontend/assets/img/logo.png')}}" alt="Nischinto"></a>
          </div>
  ...
  <div class="st-content">
    <!-- Start Hero Seciton -->
    <div class="st-hero-wrap st-gray-bg st-dynamic-bg overflow-hidden st-fixed-bg" data-src="{{url('frontend/assets/img/hero-bg')}}.jpg">
      ...
      <div class="st-hero-shape"><img src="{{url('frontend/assets/img/shape/hero-shape.png')}}" alt="hero shape"></div>
    </div>
    <!-- End Hero Seciton -->
    ...
    <section class="st-about-wrap" id="about">
      <div class="st-shape-bg">
        <img src="{{url('frontend/assets/img/shape/about-bg-shape.svg')}}" alt="shape">
      </div>
            ...
            <div class="st-vertical-middle">
              <div class="st-vertical-middle-in">
                <div class="st-text-block st-style1">
                  <h2 class="st-text-block-title">A hospital is a health care institution providing patient treatment
                  ...
                  <div class="st-text-block-avatar">
                    <div class="st-avatar-img"><img src="{{url('frontend/assets/img/avatar1.png')}}" alt="avatar"></div>
          ...
          <ul class="st-tab-links st-style1 st-mp0">
            ...
            <li class="st-tab-title">
              <a href="#X-ray" class="st-red-box">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                  y="0px" viewBox="0 0 480 480" xml:space="preserve">
                  <g>
            ...
            <li class="st-tab-title">
              <a href="#Cardiology" class="st-dip-blue-box">
                <svg height="512pt" viewBox="-73 0 512 512.001" width="512pt" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <li class="st-tab-title">
              <a href="#DentalCare" class="st-orange-box">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                  y="0px" viewBox="0 0 480.335 480.335" xml:space="preserve">
                  <g>
          ...
          <div class="tab-content">
            <div id="Crutches" class="st-tab active">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{url('frontend/assets/img/crutches.png')}}" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
            ...
            <div id="X-ray" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{url('frontend/assets/img/xray.png')}}" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
            ...
            <div id="Pulmonary" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{url('frontend/assets/img/pulmonary.png')}}" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
            ...
            <div id="Cardiology" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{url('frontend/assets/img/cardiology.png')}}" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
            ...
            <div id="DentalCare" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{url('frontend/assets/img/dental-care.png')}}" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
            ...
            <div id="Neurology" class="st-tab">
              <div class="st-imagebox st-style2">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="st-imagebox-img"><img src="{{url('frontend/assets/img/neurology.png')}}" alt="service"></div>
                    <div class="st-height-b0 st-height-lg-b30"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="st-vertical-middle">
    ...
    <section id="appointment" class="st-shape-wrap st-gray-bg">
      <div class="st-shape4">
        <img src="{{url('frontend/assets/img/shape/section_shape.png')}}" alt="shape1">
      </div>
      <div class="st-shape6">
        <img src="{{url('frontend/assets/img/shape/contact-shape3.svg')}}" alt="shape3">
      </div>
      <div class="st-height-b120 st-height-lg-b80"></div>
      <div class="container">
        <div class="st-section-heading st-style1">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <form method="POST" action="{{url('frontend/assets/php/appointment.php')}}" class="st-appointment-form" id="appointment-form">
          ...
          <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
            ...
            <div class="slick-wrapper">
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="{{url('frontend/assets/img/member1.jpg')}}" alt="" class="st-zoom-in">
                    <a class="st-doctor-link" href="doctor-profile.html"><i class="fas fa-link"></i></a>
                    <div class="st-member-social-wrap">
                      <img src="{{url('frontend/assets/img/shape/member-shape.svg')}}" alt="shape" class="st-member-social-bg">
              ...
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="{{url('frontend/assets/img/member2.jpg')}}" alt="member2" class="st-zoom-in">
                    <a class="st-doctor-link" href="doctor-profile.html"><i class="fas fa-link"></i></a>
                    <div class="st-member-social-wrap">
                      <img src="{{url('frontend/assets/img/shape/member-shape.svg')}}" alt="shape" class="st-member-social-bg">
                      <ul class="st-member-social st-mp0">
              ...
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="{{url('frontend/assets/img/member3.jpg')}}" alt="member3" class="st-zoom-in">
                    <a class="st-doctor-link" href="doctor-profile.html"><i class="fas fa-link"></i></a>
                    <div class="st-member-social-wrap">
                      <img src="{{url('frontend/assets/img/shape/member-shape.svg')}}" alt="shape" class="st-member-social-bg">
                      <ul class="st-member-social st-mp0">
              ...
              <div class="slick-slide-in">
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    <img src="{{url('frontend/assets/img/member4.jpg')}}" alt="member4" class="st-zoom-in">
                    <a class="st-doctor-link" href="doctor-profile.html"><i class="fas fa-link"></i></a>
                    <div class="st-member-social-wrap">
                      <img src="{{url('frontend/assets/img/shape/member-shape.svg')}}" alt="shape" class="st-member-social-bg">
                      <ul class="st-member-social st-mp0">
    ...
    <!-- Start Before After -->
    <section class="st-before-after-section st-dynamic-bg st-bg" data-src="{{url('frontend/assets/img/before-after-bg.jpg')}}">
      <div class="st-height-b120 st-height-lg-b80"></div>
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">Before and after procedures</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="{{url('frontend/assets/img/icons/4.png')}}" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
        ...
        <div class="container">
          <div class="st-before-after-in">
            <div class="st-before-after">
              <div class="st-after st-single-slide st-dynamic-bg" data-src="{{url('frontend/assets/img/after.jpg')}}"></div>
              <div class="st-before st-single-slide st-dynamic-bg" data-src="{{url('frontend/assets/img/before.jpg')}}"></div>
            ...
            <div class="slick-wrapper">
              <div class="slick-slide-in">
                <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
                  ...
                  <div class="st-testimonial-text">Lorem Ipsum is simply dummy text of the printing and typesetting
        ...
        <div class="row">
          ...
          <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
            <div class="st-video-block st-style1 st-zoom">
              <div class="st-video-block-img st-zoom-in st-dynamic-bg" data-src="{{url('frontend/assets/img/video-block-img.jpg')}}"></div>
              ...
              <div class="slick-slide-in">
                <div class="st-pricing-table st-style1">
                  <div class="st-pricing-head">
                    ...
                    <img src="{{url('frontend/assets/img/shape/price-shape.svg')}}" alt="shape" class="st-pricing-head-shape">
                  </div><!-- .st-pricing-head -->
                  <div class="st-pricing-feature">
                    ...
                    <div class="st-pricing-btn">
                      <a href="#" class="st-btn st-style2 st-color1 st-size-medium">Contact Now</a>
                    </div>
                    <div class="st-height-b30 st-height-lg-b30"></div>
                  </div>
                </div>
    ...
    <section class="st-faq-wrap st-shape-wrap">
      <div class="st-shape5">
        <img src="{{url('frontend/assets/img/shape/faq-bg.svg')}}" alt="shape1">
      </div>
      <div class="st-height-b120 st-height-lg-b80"></div>
      <div class="container">
        <div class="row">
            ...
            <div class="st-vertical-middle">
              <div class="st-vertical-middle-in">
                <div class="st-faq-img">
                  <img src="{{url('frontend/assets/img/faq-img.png')}}" alt="Faq Image">
                </div>
              </div>
            </div>
            <div class="st-height-b0 st-height-lg-b30"></div>
    ...
    <!-- Start News Letter -->
    <section class="st-news-letter-section st-dynamic-bg st-bg" data-src="{{url('frontend/assets/img/news-letter-bg.png')}}">
      <div class="container">
        <div class="st-section-heading st-style1">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            <div class="st-post st-style3">
              <a href="blog-details-right-sidebar.html" class="st-post-thumb st-link-hover-wrap st-zoom">
                <img class="st-zoom-in" src="{{url('frontend/assets/img/blog1.jpg')}}" alt="blog1">
          ...
          <div class="col-lg-4">
            <div class="st-post st-style3">
              <a href="blog-details-right-sidebar.html" class="st-post-thumb st-link-hover-wrap st-zoom">
                <img class="st-zoom-in" src="{{url('frontend/assets/img/blog2.jpg')}}" alt="blog1">
                <span class="st-link-hover"><i class="fas fa-link"></i></span>
              </a>
              <div class="st-post-info">
          ...
          <div class="col-lg-4">
            <div class="st-post st-style3">
              <a href="blog-details-right-sidebar.html" class="st-post-thumb st-link-hover-wrap st-zoom">
                <img class="st-zoom-in" src="{{url('frontend/assets/img/blog3.jpg')}}" alt="blog1">
                <span class="st-link-hover"><i class="fas fa-link"></i></span>
              </a>
              <div class="st-post-info">
            ...
            <div class="slick-wrapper">
              <div class="slick-slide-in">
                <div class="st-logo-carousel st-style1 st-orange-box">
                  <img src="{{url('frontend/assets/img/client1.png')}}" alt="client1">
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-logo-carousel st-style1 st-blue-box">
                  <img src="{{url('frontend/assets/img/client2.png')}}" alt="client2">
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-logo-carousel st-style1 st-red-box">
                  <img src="{{url('frontend/assets/img/client3.png')}}" alt="client3">
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-logo-carousel st-style1 st-green-box">
                  <img src="{{url('frontend/assets/img/client4.png')}}" alt="client4">
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-logo-carousel st-style1 st-dip-blue-box">
                  <img src="{{url('frontend/assets/img/client5.png')}}" alt="client5">
                </div>
              </div><!-- .slick-slide-in -->
              <div class="slick-slide-in">
                <div class="st-logo-carousel st-style1 st-orange-box">
    ...
    <section class="st-shape-wrap" id="contact">
      <div class="st-shape1"><img src="{{url('frontend/assets/img/shape/contact-shape1.svg')}}" alt="shape1"></div>
      <div class="st-shape2"><img src="{{url('frontend/assets/img/shape/contact-shape2.svg')}}" alt="shape2"></div>
      <div class="st-height-b120 st-height-lg-b80"></div>
      <div class="container">
        <div class="st-section-heading st-style1">
          ...
          <div class="col-lg-3">
            <div class="st-footer-widget">
              <div class="st-text-field">
                <img src="{{url('frontend/assets/img/footer-logo.png')}}" alt="Nischinto" class="st-footer-logo">
                <div class="st-height-b25 st-height-lg-b25"></div>
  ...
  <script src="{{url('frontend/assets/js/isotope.pkg.min.js')}}"></script>
  <script src="{{url('frontend/assets/js/jquery.slick.min.js')}}"></script>
  <script src="{{url('frontend/assets/js/mailchimp.min.js')}}"></script>
  <script src="{{url('frontend/assets/js/counter.min.js')}}"></script>
  <script src="{{url('frontend/assets/js/lightgallery.min.js')}}"></script>
  <script src="{{url('frontend/assets/js/ripples.min.js')}}"></script>
